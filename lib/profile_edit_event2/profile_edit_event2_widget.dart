    ...
    return AuthUserStreamWidget(
      child: StreamBuilder<List<UsersRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<UsersRecord> profileEditEvent2UsersRecordList = snapshot.data;
          // Return an empty Container when the document does not exist.
          if (snapshot.data.isEmpty) {
            return Container();
          }
          final profileEditEvent2UsersRecord =
              profileEditEvent2UsersRecordList.isNotEmpty
                  ? profileEditEvent2UsersRecordList.first
                  : null;
          return Scaffold(
            key: scaffoldKey,
              ...
              child: StreamBuilder<List<EventsRecord>>(
                stream: queryEventsRecord(
                  queryBuilder: (eventsRecord) => eventsRecord
                      .where('owner',
                          isEqualTo: profileEditEvent2UsersRecord.reference)
