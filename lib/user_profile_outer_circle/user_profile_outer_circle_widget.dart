...
import '../main.dart';
import '../user_profile_listofcircle/user_profile_listofcircle_widget.dart';
...
class UserProfileOuterCircleWidget extends StatefulWidget {
  UserProfileOuterCircleWidget({
    Key key,
    this.refEvent,
    this.eventTitle,
    this.eventLocation,
  ...
  @override
  _UserProfileOuterCircleWidgetState createState() =>
      _UserProfileOuterCircleWidgetState();
}

class _UserProfileOuterCircleWidgetState
    extends State<UserProfileOuterCircleWidget> {
