...
class UserProfileInnerCircleWidget extends StatefulWidget {
  UserProfileInnerCircleWidget({
    Key key,
    this.refEvent,
    this.eventTitle,
    this.eventLocation,
  ...
  @override
  _UserProfileInnerCircleWidgetState createState() =>
      _UserProfileInnerCircleWidgetState();
}

class _UserProfileInnerCircleWidgetState
    extends State<UserProfileInnerCircleWidget> {
