...
class SendInvitationsSpecificUserWidget extends StatefulWidget {
  SendInvitationsSpecificUserWidget({
    Key key,
    this.refEvent,
    this.eventTitle,
    this.eventLocation,
  ...
  @override
  _SendInvitationsSpecificUserWidgetState createState() =>
      _SendInvitationsSpecificUserWidgetState();
}

class _SendInvitationsSpecificUserWidgetState
    extends State<SendInvitationsSpecificUserWidget> {
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            'Invite specific users from your Inner Circle to your event. Only they will see the event and receive the notification to join.',
