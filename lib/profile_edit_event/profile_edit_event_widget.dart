...
class ProfileEditEventWidget extends StatefulWidget {
  ProfileEditEventWidget({Key key}) : super(key: key);
      ...
      child: AuthUserStreamWidget(
        child: StreamBuilder<List<UsersRecord>>(
          ...
          builder: (context, snapshot) {
            ...
            List<UsersRecord> profileEditEventUsersRecordList = snapshot.data;
            // Return an empty Container when the document does not exist.
            if (snapshot.data.isEmpty) {
              return Container();
            }
            final profileEditEventUsersRecord =
                profileEditEventUsersRecordList.isNotEmpty
                    ? profileEditEventUsersRecordList.first
                    : null;
            return Scaffold(
              key: scaffoldKey,
                              ...
                              onPressed: () async {
                                ...
                                try {
                                  ...
                                  final eventsCreateData =
                                    ...
                                    endDateEvent: datePicked3,
                                    owner:
                                        profileEditEventUsersRecord.reference,
                                    privacyType: 'Public',
                                    guestCount: 0,
                                    ownerName:
                                        profileEditEventUsersRecord.displayName,
                                  );
                                  ...
                                  await Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) => HostEvent2Widget(
                                        ...
                                        descriptionEvent: textController2.text,
                                        locationEvent: textController3.text,
                                        dateEventStart: datePicked1,
                                        dateEventEnd: datePicked3,
