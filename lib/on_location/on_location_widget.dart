...
class OnLocationWidget extends StatefulWidget {
  OnLocationWidget({Key key}) : super(key: key);

  @override
  _OnLocationWidgetState createState() => _OnLocationWidgetState();
}

class _OnLocationWidgetState extends State<OnLocationWidget> {
